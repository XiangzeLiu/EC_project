...
11. TS 重复订单时间窗已暂时关闭，Client 仅保留按键输入层重复保护。
...
17. 旧三端通信梳理文档已归档删除，后续以 `生产落地.md` 为上线依据；`证券股票交易系统产品文档_合并版.md` 暂作参考。
...
26. Client/TS 临时延迟诊断埋点、采集脚本和采集日志已完成清理。
27. Client 认证时长已恢复为生产配置 24 小时。
